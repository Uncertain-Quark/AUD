...
void doc_example_2_test(int test)
{
    ...
    fprintf(spfp,"Actually=%ld\n",sample_n_bytes);
    fprintf(spfp,"---- Example 2: Expected sample_count=48000,   ");
    fprintf(spfp,"Actually=%ld\n",sample_count);
    fprintf(spfp,"---- Example 2: Expected total_samples=48000,  ");
...
void doc_example_4_test(int test)
{
    ...
    short *wavbuf;
    SP_INTEGER lint;
    SP_INTEGER buf_nsamp = 48000;
    SP_INTEGER nbyte = 2;
    SP_INTEGER srate = 48000;
    int stow, i;
...
void write_required_field_test(int test)
{
	...
	if (i > 3) { sp_h_set_field(spp, "sample_coding", 
				    T_STRING, (void *) "pcm"); }
	if (i > 3) { lint = 48000;  sp_h_set_field(spp, "sample_rate", 
						   T_INTEGER, (void *) &lint);}
